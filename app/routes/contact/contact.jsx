...
export async function action({ request }) {
  // Initialize AWS SES using credentials from environment variables
  ...
  const isBot = String(formData.get('name')); // Honeypot field
  ...
  // Send email via Amazon SES using environment variables
  await ses.send(
